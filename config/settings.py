...
SECRET_KEY = 'django-insecure-m8*iohcxp&+)0(l#z(du7l3x#bt7vn#po1)5mfpc!*uzd*-k=('
...
REST_FRAMEWORK = {
    ...
    # 'DEFAULT_VERSIONING_CLASS': 'rest_framework.versioning.HostNameVersioning',# На прод http://v1.example.com/users
